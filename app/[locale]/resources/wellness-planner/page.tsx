          ...
          <div key={step} className="flex items-center">
            <div className="flex flex-col items-center">
              <div
                ...
                style={isActive ? { background: "#231E17" } : {}}
              >
                {isDone ? "✓" : step}
              </div>
              <span
            ...
            <div className="space-y-6">
              ...
              <div className="bg-surface-card rounded-2xl p-8">
                ...
                <input
                  ...
                  className="w-full border border-outline-variant rounded-xl px-4 py-3 font-sans text-sm text-on-surface bg-bg placeholder-on-surface-variant/50 focus:outline-none focus:border-primary transition-colors"
                />
              </div>
              ...
              <div className="bg-surface-card rounded-2xl p-8">
                ...
                <input
                  ...
                  className="border border-outline-variant rounded-xl px-4 py-3 font-sans text-sm text-on-surface bg-bg focus:outline-none focus:border-primary transition-colors"
                />
              </div>
