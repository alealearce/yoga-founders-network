...
export const PRODUCT_CATEGORIES     = ["Yoga Mats", "Clothing & Apparel", "Altar & Ritual", "Props & Equipment", "Books & Media", "Supplements & Wellness", "Online Courses", "Accessories"] as const;
